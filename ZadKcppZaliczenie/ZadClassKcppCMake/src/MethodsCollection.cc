...
void MethodsCollection::invokeMethod(int methodNumber) {
    switch (methodNumber) {
        case 1:
            enumExample();
            break;
...
void MethodsCollection::displayMethodDescription(int methodNumber) {
    switch (methodNumber) {
        case 1:
...
void MethodsCollection::arrayManipulationExample() {
    int size;
...
void MethodsCollection::returnTypesExample() {
    int input;
...
int MethodsCollection::returnValueByValue(int x) {
    return x;
}

void MethodsCollection::returnValueByReference(int x, int& result) {
    result = x;
}

void MethodsCollection::returnValueByPointer(int x, int* result) {
    *result = x;
}

void MethodsCollection::returnValueByArray(int x, int result[]) {
    result[0] = x;
}


void MethodsCollection::enumExample() {
...
void MethodsCollection::fileIOExample() {
...
void MethodsCollection::binaryToIntegerExample() {
