...
void Menu::run() {
    short choice;
    MethodsCollection methodsCollectionObj;
    ...
    while (isRunning) {
        ...
        switch (choice) {
            ...
            case 6:
                ...
                methodsCollectionObj.displayMethodDescription(choice);
                std::cout << "\nContinue? (0 - exit): ";
                std::cin >> choice;
                ...
                break;
            default:
                chooseProgram(choice, methodsCollectionObj);
                std::cout << "\nContinue? (0 - exit): ";
                std::cin >> choice;
...
void Menu::chooseProgram(short choice, MethodsCollection& methodsCollection) {
    switch (choice) {
        case 1:
        case 2:
        case 3:
            methodsCollection.invokeMethod(choice);
            break;
        case 4:
            methodsCollection.arrayManipulationExample();
            break;
        case 5:
            methodsCollection.returnTypesExample();
            break;
        case 6:
            std::cout << "Choose a method: ";
            std::cin >> choice;
            ...
            std::cout << "\nMethod " << choice << "." << std::endl;
            methodsCollection.displayMethodDescription(choice);
            std::cout << "\nContinue? (0 - exit): ";
            std::cin >> choice;
